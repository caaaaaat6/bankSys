...
public class Role {
    ...
    public static final String FIXED_HEAD_EMPLOYEE_ROLE = "ROLE_FIXED_HEAD";
    public static final String SYSTEM_ADMIN_ROLE = "ROLE_ADMIN";
    public static final String EMPLOYEE_ROLE = "ROLE_EMPLOYEE";

    public static final String CURRENT_RIGHT = "CURRENT";
    public static final String FIXED_RIGHT = "FIXED";
    ...
    public static final String FIXED_HEAD_EMPLOYEE = "FIXED_HEAD";
